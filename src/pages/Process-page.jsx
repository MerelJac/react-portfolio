...
export const ProcessPage = () => {
    return (
        ...
        <h1 className="font-primary text-lg flex justify-center text-center">Design, Develop, Deploy</h1>
        <section className="p-4 justify-around flex flex-col contents-center sm:flex-row">

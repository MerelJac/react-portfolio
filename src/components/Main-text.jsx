...
import githubIcon from "../images/github-icon-temp.png";
import linkedinIcon from "../images/linkedin-temp.png";
import emailIcon from "../images/email-temp.png";
...
export const MainText = (props) => {
  ...
  return (
    <>
      <section className="h-[100vh] flex justify-center items-end" style={sectionStyle}>
